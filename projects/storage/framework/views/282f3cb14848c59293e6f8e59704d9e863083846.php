...
<?php $__currentLoopData = $main_data['data']['components']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($c['isIncludedInTotalPrice']==0): ?>
        <?php if($c['name']!="baseRate"): ?>
         ...
         <?php endif; ?>
   <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/webdesignvrvr-asif/htdocs/asif.webdesignvrvr.com/projects/resources/views/front/property/ajax-gaurav-data-get-quote.blade.php ENDPATH**/ ?>