                 ...
                 <div class="collapse navbar-collapse" id="main_nav">
                    <ul class="navbar-nav">
                       <li class="nav-item"><a class="nav-link" href="<?php echo e(url('blogs')); ?>"> Blogs </a></li>
                         <li class="nav-item"><a class="nav-link" href="<?php echo e(url('faqs')); ?>"> Faqs </a></li>
...
<?php /**PATH /home/hiddencharmsuites/htdocs/www.hiddencharmsuites.com/projects/resources/views/front/layouts/header.blade.php ENDPATH**/ ?>