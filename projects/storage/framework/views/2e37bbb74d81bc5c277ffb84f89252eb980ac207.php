...
$list=App\Models\HostAway\HostAwayProperty::where("collection_ids",'like','%"'.$data->id.'"%')->orderBy("id","desc")->paginate(100);
							...
							<div class="adult-popup" id="guestsss">
								...
								<div class="adult-box">
									<div class="adult-value">
										<p id="adults-data-show"><?php if(Request::get('adults')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webdesignvrvr-rupa/htdocs/rupa.webdesignvrvr.com/projects/resources/views/front/property/category.blade.php ENDPATH**/ ?>