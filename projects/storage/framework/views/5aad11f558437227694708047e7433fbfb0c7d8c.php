                        ...
                        <div class="card-form">                             
                            ...
                            <div class='row'>
                                <?php $__currentLoopData = $additional_new_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(isset($label)): ?>
                                    <?php $label = preg_replace('/\$/', '<span style="font-family:sans-serif;">$</span>', $label); ?>
                                    <?php endif; ?>
                                    
                                   <?php if($c['feeTitle']=="Damage Insurance"): ?>
                              		<div class="col-12 p-0">                                  		
                                       <label for="price"><?php echo $label; ?></label>
                        ...
                        <div class="price-details">
                            ...
                            <div class="price-area">
                                <div class="prc fees">
                                    <div class="fees-value">
                                        <p class="value"><span class="val" style="font-family:sans-serif;"><?php echo e($sign); ?><?php echo e(number_format($base_price/$total_night,2)); ?> x <?php echo e($total_night); ?> nights</span></p>
                                        <div class="discount-price-box">
                                            ...
                                            <?php for($i=0;$i<$total_night;$i++): ?>
                                              ...
                                              <div>
                                                    ...
                                                    <p class="amt" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($c->price*$partnersListingMarkup,2)); ?></p>
                                                </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php endfor; ?>
                                            </div>
                                            <div class="price-box-bottom">
                                                <p>Total</p>
                                                <p class="amt" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($base_price,2)); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="total" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($base_price,2)); ?></p>
                                </div>
                                                ...
                                                <div class="price-box-content">
                                                    <?php $__currentLoopData = $show_data_amount[$key]['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div>
                                                            ...
                                                            <p class="amt" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($c1['total'],2)); ?></p>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                                <div class="price-box-bottom">
                                                    <p>Total</p>
                                                    <p class="amt" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($show_data_amount[$key]['total'],2)); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <p class="total" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($show_data_amount[$key]['total'],2)); ?></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div id="main_total_data_show">
                                <div class="total-amt">
                                    ...
                                    <p class="total" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($main_data['data']['totalPrice'],2)); ?></span></p>
                                </div>
                            </div>
                            <div class="price-area">
                                <?php $__currentLoopData = $main_data['data']['components']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($c['isIncludedInTotalPrice']==0): ?>
                                        <?php if($c['name']!="baseRate"): ?>
                                            <div class="prc fees">
                                                    ...
                                                    <div class="discount-price-box">
                                                        ...
                                                        <div class="price-box-content">
                                                            <div>
                                                                ...
                                                                <p class="amt" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($c['total'],2)); ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="price-box-bottom">
                                                            <p>Total</p>
                                                ...
                                                <p class="total" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($c['total'],2)); ?></p>
                                            </div>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $amount_data_hostaway; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="total-amt">
                                        ...
                                        <p class="total" style="font-family:sans-serif;"><?php echo e($sign); ?> <?php echo e(number_format($c['amount'],2)); ?></span></p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<script>
        ...
        $(document).ready(function() {
            ...
            var options = <?php echo json_encode($country); ?>;;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/noelcosystays/htdocs/www.noelcosystays.com.au/projects/resources/views/front/static/get-quote.blade.php ENDPATH**/ ?>