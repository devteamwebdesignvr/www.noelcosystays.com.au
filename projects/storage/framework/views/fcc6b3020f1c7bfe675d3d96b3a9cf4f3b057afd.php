...
<div class="row">
    <div class="col-md-6">
        <span style="font-size:13px;font-family:sans-serif;"><?php echo $main_data['currency']; ?> <?php echo e(number_format($base_price/$total_night,2)); ?> X <?php echo e($total_night); ?> Nights</span>
    </div>
    <div class="col-md-6">
       <?php echo $main_data['currency']; ?>  <?php echo e(number_format($base_price,2)); ?>
        ...
        <?php if($c['name']!="baseRate"): ?>
		   <div class="row">
                ...
                <div class="col-md-6" style="font-family:sans-serif;">
                   <?php echo $main_data['currency']; ?> <?php echo e(number_format($c['total'],2)); ?>
...
<div class="row">
    ...
    <div class="col-md-6" style="font-family:sans-serif;">
       <?php echo $main_data['currency']; ?> <?php echo e(number_format($main_data['data']['totalPrice'],2)); ?>
...
<?php $__currentLoopData = $main_data['data']['components']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($c['isIncludedInTotalPrice']==0): ?>
        <?php if($c['name']!="baseRate"): ?>
         ...
         <?php endif; ?>
   <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/noelcosystays/htdocs/www.noelcosystays.com.au/projects/resources/views/front/property/ajax-gaurav-data-get-quote.blade.php ENDPATH**/ ?>