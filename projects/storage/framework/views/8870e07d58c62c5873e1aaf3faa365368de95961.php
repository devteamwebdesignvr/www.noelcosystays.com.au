              ...
              <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                 <div class="collapse navbar-collapse" id="main_nav">
                    <ul class="navbar-nav">
                       ...
                       <li class="nav-item"><a class="nav-link" href="<?php echo e(url('properties')); ?>">Browse All Properties</a></li>
                     <li class="nav-item"><a class="nav-link" href="<?php echo e(url('properties')); ?>"> Book Now </a></li>
                    </ul>
                 </div>
              </nav>
           </div>
...
<?php /**PATH /home/noelcosystays/htdocs/www.noelcosystays.com.au/projects/resources/views/front/layouts/header.blade.php ENDPATH**/ ?>