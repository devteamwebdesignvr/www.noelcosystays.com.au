  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-4 first">
        ...
        <div class="logos">
         <a href="<?php echo e(url($setting_data['vrbo'] ?? '#')); ?>"><img src="<?php echo e(asset('front')); ?>/images/vrbo.png" alt=""></a>
         <a href="<?php echo e(url($setting_data['airbnb'] ?? '#')); ?>"><img src="<?php echo e(asset('front')); ?>/images/airbnb.png" alt=""></a>
         <a href="<?php echo e(url($setting_data['booking'] ?? '#')); ?>"><img src="<?php echo e(asset('front')); ?>/images/booking.jpg" alt=""></a>
          <a href="<?php echo e(url($setting_data['expedia'] ?? '#')); ?>"><img src="<?php echo e(asset('front')); ?>/images/expedia-img.png" alt=""></a>
        </div>
      </div>
      <div class="col-8 quick">
        <ul class="quick-links">
          <li><a href="<?php echo e(url('/')); ?>">Home</a></li>
              <li><a href="<?php echo e(url('properties')); ?>">Browse All Properties</a></li>
              <li><a href="<?php echo e(url('properties')); ?>"> Book Now </a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-5 ">
          <div class="center-copyright">
            <p>Designed &amp; Developed by <a href="https://www.webdesignvr.com/" target="_blank"><img src="<?php echo e(asset('front')); ?>/images/footer_img.webp" alt="Webdesignvr"></a></p>
            </div>
          </div>
      </div>
    </div>
...
</script><?php /**PATH /home/noelcosystays/htdocs/www.noelcosystays.com.au/projects/resources/views/front/layouts/footer.blade.php ENDPATH**/ ?>