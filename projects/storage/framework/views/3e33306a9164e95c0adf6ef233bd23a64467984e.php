...
<?php 
    $name="Booking Enquiry Home";$route="booking_enquiry_home";
?>              
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php echo e(App\Models\HostAway\HostAwayProperty::find($client->property_id)->name ?? ''); ?>
                          ...
                          <td><?php echo e($client->how_did_you_hear_about_us); ?></td>
                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/noelcosystays/htdocs/www.noelcosystays.com.au/projects/resources/views/admin/booking_enquiry_home/index.blade.php ENDPATH**/ ?>