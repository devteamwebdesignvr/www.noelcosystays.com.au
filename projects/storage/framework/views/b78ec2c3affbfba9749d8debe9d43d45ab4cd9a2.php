           ...
           <div class="col-lg-8 col-xs-12 col-md-12">
              ...
              <div class="blog-detail-left">
                 ...
                 <div class="blog-detail-image">
                    ...
                    <img src="<?php echo e(asset($data->featureImage)); ?>">
...
<?php $__env->startSection("css"); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('front')); ?>/css/blog-responsive.css" />
<?php $__env->stopSection(); ?> 
<?php $__env->startSection("js"); ?>
    <?php echo \Illuminate\View\Factory::parentPlaceholder('js'); ?>
    <script src="<?php echo e(asset('front')); ?>/js/blog.js" ></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webdesignvrvr-lee-anne/htdocs/lee-anne.webdesignvrvr.com/projects/resources/views/front/group/single.blade.php ENDPATH**/ ?>