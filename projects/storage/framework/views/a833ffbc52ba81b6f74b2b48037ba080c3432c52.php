   ...
   var checkin = '';
    var checkout = '';
     $(function(){
        ...
        url="<?php echo e(route('get-checkin-checkout-data')); ?>";
                 ...
                 if($("#txtTo").val()!=""){
                    if($("#adult_data").val()>0){
                        data={
                         ...
                         $.post("<?php echo e(route('admin-checkajax-get-quote-edit')); ?>",data,function(data){
                            if(data.status==400){
                                $("#submit-button-gaurav-data").hide();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/noelcosystays/htdocs/www.noelcosystays.com.au/projects/resources/views/admin/booking_enquiry_home/edit.blade.php ENDPATH**/ ?>