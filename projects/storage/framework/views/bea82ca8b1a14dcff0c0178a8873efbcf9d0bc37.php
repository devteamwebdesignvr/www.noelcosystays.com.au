                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php echo e(App\Models\Location::find($client->location_id)->name ??''); ?>

                            </td>
                            <td>
                                <?php echo e(App\Models\AttractionCategory::find($client->category_id)->name ??''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webdesignvrvr-lee-anne/htdocs/lee-anne.webdesignvrvr.com/projects/resources/views/admin/attractions/index.blade.php ENDPATH**/ ?>