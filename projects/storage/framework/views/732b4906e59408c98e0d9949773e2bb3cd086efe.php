      ...
      <div class="container">
         <div class="search-bar">
            ...
            <form method="get" action="<?php echo e(url('properties')); ?>">
               <div class="row">
                  <div class="col-2 md-12 sm-12 select ">
                  ...
                  <div class="col-2 md-12 sm-12 guest-info">
...
<?php
$locaiton = App\Models\Location::orderBy('id')->get();
?>
...
<section class="featured-pro" id="abt">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-12 main-prop" data-aos="fade-left" data-aos-duration="1000">
...
<section class="about-owner">
    <div class="container px-0 lg-px-2">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 img" data-aos="fade-right" data-aos-duration="1000">
                <div class="abt-owner">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 cont" data-aos="fade-left" data-aos-duration="1000">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webdesignvrvr-reji/htdocs/reji.webdesignvrvr.com/projects/resources/views/front/static/home.blade.php ENDPATH**/ ?>