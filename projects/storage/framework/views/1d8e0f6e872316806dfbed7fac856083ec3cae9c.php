  ...
  <div class="row">
	...
	<div class="col-md-12">
		<div class="form-group">
		    ...
		    <?php echo Form::select("input['which_payment_gateway']",["authorize"=>"authorize","paypal"=>"paypal","stripe"=>"stripe","paypal_and_stripe"=>"Both, Paypal & Stripe"],ModelHelper::getDataFromSetting('which_payment_gateway'),["class"=>"form-control"]); ?>
 ...
 <h5 class="text-warning">Paypal</h2>
 <div class="row">
...
<?php /**PATH /home/hiddencharmsuites/htdocs/www.hiddencharmsuites.com/projects/resources/views/admin/dashboard/sub/admin.blade.php ENDPATH**/ ?>