    ...
    */
    ...
    'menu' => [
      ...
      //  ["text"=>"Amenities Includes","url"=>"admin/our-clients","permission"=>"admin",'icon' => 'fas fa-fw fa-user'],
         ["text"=>"Galleries","url"=>"admin/galleries","permission"=>"admin",'icon' => 'fas fa-fw fa-user'],
        ...
        [
            ...
            'submenu' => [
                ...
                ["text"=>"Collection List","url"=>"admin/categories","permission"=>"admin",'icon' => 'fas fa-fw fa-user'],
                ["text"=>"Property List","url"=>"admin/host_away_properties","permission"=>"admin",'icon' => 'fas fa-fw fa-user'],
                ["text"=>"Attraction List","url"=>"admin/attractions","permission"=>"admin",'icon' => 'fas fa-fw fa-user'],
                ["text"=>"Attraction Category List","url"=>"admin/attraction-categories","permission"=>"admin",'icon' => 'fas fa-fw fa-user'],
