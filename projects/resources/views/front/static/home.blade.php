...
<div class="head-sec">
      ...
      <div class="row">
         ...
         @endif
            ...
            <a href="{{ url($c->seo_url) }}"><img src="{{ asset($image)}}" class="img-fluid" alt="{{$c->name}}"></a>
           
            </div>
            <div class="pro-cont ">
               <h3 class="title"><a href="{{ url($c->seo_url) }}">{{$c->title ?? $c->name}}</a></h3>
               <div class="amn">
                     <ul class="first">
                  @if($c->personCapacity)
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-5 col-12 abt-left">
            ...
            <a  href="{{ url('about-us') }}" class="main-btn" data-aos="fade-up" data-aos-duration="1000">
            <span class="circle">
         ...
         <div class="col-lg-7 col-12 abt-right">
            <div class="abt-co-img">
                  ...
                  @if($data->about_image1)<img src="{{asset($data->about_image1)}}" class="img-fluid" alt="">@endif
               </div>
                                             <div class="abt-co-img-right" >
                  @if($data->about_image2)<img src="{{asset($data->about_image2)}}" class="img-fluid" alt="">@endif
               </div>
                           </div>
         </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-12 main-prop" data-aos="fade-top" data-aos-duration="1000">
        <div class="prop-contt">
          ...
          <a href="{{url('properties/location/'.$c->seo_url)}}">
          </a>
        </div>
      </div>
      @endforeach
    ...
    <div class="container">
        <div class="row">
            <div class="col-3 md-12 sm-12">
                ...
                <a href="#" data-href="{{ url('gallery') }}" class="main-btn gallery-btn"><i class="fa-solid fa-image"></i> View All Photos </a>
            </div>
            <div class="col-9 md-12 sm-12">
                <div class="row rev">
                        @php $i=1;@endphp
                  @foreach(App\Models\Gallery::orderBy("id","desc")->limit(6)->get() as $c)
                     @if($i==1 || $i==4 || $i==5)
                         <div class="col-7">
                     @else
                         <div class="col-5">
                     @endif
                           <div class="img">
                              <a href="#" data-href="{{ asset($c->image)}}" data-fancybox="images">
      ...
      <div class="row">
         <div class="col-12">
            <div class="box">
               ...
               <a  href="#" data-href="{{ url('contact-us') }}" class="main-btn ">Let's Connect <i class="fa-solid fa-arrow-right"></i></a>
            </div>
         </div>
      </div>
   </div>
...
<div class="head-sec">
      ...
      <div class="row">
         ...
         <div class="col-lg-4 col-md-6 col-sm-12 prop-card aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500">
            <div class="pro-img">                           
             <a href="{{ url('attractions/detail/'.$c->seo_url) }}"><img src="{{ asset($c->image)}}" class="img-fluid" alt="{{$c->name}}"></a>           
            </div>
            <div class="pro-cont ">
               <h3 class="title"><a href="{{ url('attractions/detail/'.$c->seo_url) }}">{{$c->title ?? $c->name}}</a></h3>
            </div>
         </div>
         @endforeach
      </div>
      <div class="attr-btn"><a href="{{ url('attractions') }}" class="main-btn">View More</a>         </div>
   </div>
</section>
@endif
                ...
                <div class="item">
                            <div class="test-card">
                                ...
                                <div class="cont-sec">
                                    ...
                                    <h3>{{Helper::getReviewName($c->guestName) ?? '' }}</h3>
                                    <div class="rating">
...
<section class="about-owner">
    <div class="container px-0 lg-px-2">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 img" ">
                <div class="abt-owner">
                   @if($data->owner_image) <div class="abt-img mb-2"><img src="{{asset($data->owner_image)}}" class="img-fluid" alt=""></div>@endif
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 cont" >
               ...
               <div class="abt-btn"><a href="{{ url('about-owner') }}" class="main-btn">View More</a>         </div>
            </div>
        </div>
    </div>
</section>
 ...
 <div class="head-sec">
  ...
  @forelse(App\Models\Blogs\Blog::orderBy('id')->limit(3)->get() as $b)
                <div class="col-lg-4 col-md-4 col-12">
                                @php $date=$b->publish_date; if($date){}else{$date=$b->created_at;} @endphp
                    <div class="blog">

                            @if($b->featureImage)
                            <a href="{{ url('blog/'.$b->seo_url) }}/"><img src="{{ asset($b->featureImage) }}" alt="{{ $b->title }}" class="img-fluid"  /></a>
                                  @endif
                            <div class="content-blog">
                            <h3><a href="{{ url('blog/'.$b->seo_url) }}/">{{$b->title}}</a></h3>
                 ...
                 <div class="col-lg-7 col-md-7 col-12 contact-form">
                    <div class="inner-container" >
                        ...
                        <div class="contact-form">
                            {!! Form::open(["route"=>"booking-contact-enquiry-post"])  !!}
   ...
   var checkin = '';
    var checkout = '';
     $(document).on("change","#property-selector",function(){
        ...
        url="{{ route('get-checkin-checkout-data-new') }}";
