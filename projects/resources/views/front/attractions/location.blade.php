            ...
            <div class="row position-relative" id="a1">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 position-relative right-contentss">
                    <div class="inner-column-content">
                        <h3 data-aos="fade-left" data-aos-duration="1500"><a  @if($c->type=="internal") href="{{ url('attractions/detail/'.$c->seo_url) }}"  @else href="{{ $c->seo_url }}" target="_BLANK"    @endif >{{$c->name}}</a></h3>
                        <div class="line"></div>
