...
<script >
 ...
 var default1=` <div class="row default">
  ...
  `;
 var weekly_price=` <div class="row default">
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label("weekly_price") !!}
                {!! Form::number("weekly_price",$data->weekly_price,["class"=>"form-control","required","min"=>"0"]) !!}
                <span class="text-danger">{{ $errors->first("weekly_price")}}</span>
            </div>
        </div>
        <div class="col-md-6 d-none">
            <div class="form-group">
  ...
  `;
 var monthly_price=` <div class="row default">
        <div class="col-md-12">
            <div class="form-group">
                {!! Form::label("monthly_price") !!}
                {!! Form::number("monthly_price",$data->monthly_price,["class"=>"form-control","required","min"=>"0"]) !!}
  ...
  `;
   ...
   $( function() {
    ...
    // $( "#datepicker1" ).datepicker({ dateFormat: 'yy-mm-dd' });
      ...
      }else if($("#type_of_price").val()=="weeklyby_day"){
        $("#price-section").html(weekly);
      }else if($("#type_of_price").val()=="monthly"){
        $("#price-section").html(monthly_price);
      }else if($("#type_of_price").val()=="weekly"){
        $("#price-section").html(weekly_price);
      }else{
          $("#price-section").html('');
      }
  } );
