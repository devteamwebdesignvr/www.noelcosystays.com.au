<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::select("type_of_price",ModelHelper::getTypeOfPrice(),null,["class"=>"form-control","required","id"=>"type_of_price","placeholder"=>"Select Type of price"]) !!}
...
<div class="row">
    ...
    <div class="col-md-4 d-none">
        <div class="form-group">
            ...
            {!! Form::number("discount_weekly",null,["class"=>"form-control","max"=>99,"min"=>0]) !!}
    ...
    <div class="col-md-4 d-none">
        <div class="form-group">
            ...
            {!! Form::number("discount_monthly",null,["class"=>"form-control","max"=>99,"min"=>0]) !!}
    ...
    <div class="col-md-4 d-none">
        <div class="form-group">
            ...
            {!! Form::text("platform_type",'custom',["class"=>"form-control"]) !!}
