<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label("Category") !!}
            {!! Form::select("category_id",ModelHelper::getAttractionCategorySelectList(),null,["class"=>"form-control","placeholder"=>"Choose Category"]) !!}
        ...
        <div class="form-group">
            {!! Form::label("type") !!}
            {!! Form::select("type",["internal"=>"internal","external"=>"external"],null,["class"=>"form-control"]) !!}
